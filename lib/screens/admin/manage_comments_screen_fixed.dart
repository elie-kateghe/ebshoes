...
class _ManageCommentsScreenState extends State<ManageCommentsScreen> {
  ...
  void _loadComments() async {
    ...
    final mockComments = [
      ...
      Comment(
        ...
        productName: 'Sneaker Premium X',
        content: 'Très déçu par la qualité, les coutures commencent à se défaire après une semaine.',
        rating: 2.0,
  ...
  void _filterComments() {
    ...
    setState(() {
      _filteredComments = _comments.where((comment) {
        final matchesQuery = comment.userName.toLowerCase().contains(query) ||
  ...
  Widget _buildCommentCard(Comment comment) {
    ...
    if (!comment.isApproved) {
      ...
      actionButtons.insert(1, IconButton(
            ...
            Row(
              children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: List.generate(5, (index) {
                              return Icon(
                                index < comment.rating.floor() ? Icons.star : Icons.star_border,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: comment.isApproved ? AppTheme.successGreen : AppTheme.warningOrange,
  ...
  void _deleteComment(Comment comment) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Voulez-vous vraiment supprimer ce commentaire de "${comment.userName}"?'),
        actions: [
          TextButton(
